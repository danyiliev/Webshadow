...
@interface BrowserViewController : UIViewController <UIActionSheetDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate> {
    ...
    IBOutlet UIView *webViewTemplate, *sideMenuView;
	IBOutlet UIScrollView *tabsView;
    IBOutlet UIView *topBar, *naviBar;
    IBOutlet UILabel *nameLabel, *signtypeLabel;
    ...
    IBOutlet UIImageView *sideImgButton;
    IBOutlet UIImageView *backImgButton;
